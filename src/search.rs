...
pub fn nearest_left(vec: &[MZ], target_val: MZ, start_index: usize) -> usize {
...
pub fn nearest_right(vec: &[MZ], target_val: MZ, start_index: usize) -> usize {
    let mut nearest_index = start_index;
    let mut next_index = start_index;
    let n = vec.len() - 1;
    if next_index >= n {
...
pub fn nearest_binary(vec: &[MZ], target_val: MZ, start_index: usize, stop_index: usize) -> usize {
    ...
    loop {
        ...
        let ratio = (max_val - target_val) as f64 / (max_val - min_val) as f64;
