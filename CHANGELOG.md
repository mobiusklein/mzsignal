...
- Fix swapped peak indices in `AlignablePeakSetLike::_similarity_score`
...
- Fix edge case in `MonotonicBlockedIterator.step` affecting a gap in the block iterator producing negative intensities. Does not affect SIMD code path

## [1.1.8] - 2026-04-13

### Fixed

- Prevent overflow in `trapz`
...
[1.1.11]: https://github.com/mobiusklein/mzsignal/compare/v1.1.10..v1.1.11
